    ...
    <body>        
        <header> {{-- Cabecera --}}
            ...
            <div style="padding-top: 30px; padding-bottom: 10px; text-align: center; font-size: 14.5px; font-weight: bold;">
                ...
                <p style="margin: -2px 8px 4px 0px">(ESCALAFÓN: SUBOFICIALES Y SARGENTOS)</p>
            </div>
         </header>
		<br>
        ...
        <section> {{-- calificacion objetiva --}}
            <div style="padding-bottom: 4px; font-size: 13px;"><u><strong>2. CALIFICACIÓN CONCEPTUAL</strong></u></div>
                <table id="calconc">{{-- jefe de personal --}}
                    <thead>
                        <tr>
                            <th colspan="4" style="background-color: #D1D7E3; text-align: left; padding: 4px 3px;">1ra. Calificación del Suboficial de Comando (Brigada o Unidad)</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                ...
                <table id="calconc">{{-- 2do comandante --}}
                    <thead>
                        <tr>
                            <th colspan="4" style="background-color: #D1D7E3; text-align: left; padding: 4px 3px; ">2da. Calificación del Comandante de Escuadrón o Jefe de Sección</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
