                 ...
                 <table style=" background: #ffffff; width: 100%;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 60%;">
                                <strong>PERIODO DE CALIFICACIÓN:</strong> <span style="color: red">01/01/2020 AL 30/06/2020</span> 
                            </td>
                        </tr>
                    </tbody>
                </table> 
            ...
            <div>
                <table id="calobj">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td >Adaptación al Trabajo Colectivo</td>
        ...
        <section> {{-- calificacion objetiva --}}
            <div style="padding-bottom: 4px; font-size: 13px;"><u><strong>2. CALIFICACIÓN CONCEPTUAL</strong></u></div>
                <table id="calconc">{{-- jefe de personal --}}
                    ...
                    <tbody>
                        <tr>
                            <td colspan="4" style="height:30px; font-size: 10px; color: red;"><i> EL SEÑOR OFICIAL NO CUMPLE LAS ORDENES EMITIDAS POR EL SUPERIOR <br>EL SEÑOR OFICIAL NO CUMPLE LAS ORDENES EMITIDAS POR EL SUPERIOR </i></td>
                        </tr>
                        <tr>
                ...
                <table id="calconc">{{-- 2do comandante --}}
                    ...
                    <tbody>
                        <tr>
                            <td colspan="4" style="height:30px; font-size: 10px; color: red;"><i>SEÑOR OFICIAL NO CUMPLE LAS ORDENES EMITIDAS POR EL SUPERIOR<br>EL SEÑOR OFICIAL NO CUMPLE LAS ORDENES EMITIDAS POR EL SUPERIOR</i></td>
                        </tr>
                        <tr>
                            <td style="width: 36%;">Calificacion Conceptual Numérica</td>
                            <td style="width: 17%; color: red; text-align: center;">45.00</td>
                ...
                <table id="sanciona">
                    ...
                    <tbody style="color: red">
                        <tr>
                            ...
                            <td style="width: 35%; padding-left: 1px;">1RA COMPAÑIA PRIMER ESCALON</td>
                        ...
                        <tr>
                            ...
                            <td style="width: 18%;">REVISTA MILITAR</td>
                            <td style="width: 10%;">GADA "91"</td>
                            <td style="width: 35%; padding-left: 1px;">5TA COMPAÑIA SEGUNDO ESCALON</td>
